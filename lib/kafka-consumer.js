...
function KafkaConsumer(conf, topicConf) {
  ...
  // Ensure that the config objects are set
  if (typeof conf !== 'object') {
    conf = {};
  }

  if (typeof topicConf !== 'object') {
    topicConf = {};
  }
...
/**
 * @description Use a mock object instead of native bindings
 *
 * This is used for testing.
 *
 * @param  {object} mock - Mock object to use instead of native bindings
 */
KafkaConsumer.useMock = function(mock) {
  Kafka = mock;
};
